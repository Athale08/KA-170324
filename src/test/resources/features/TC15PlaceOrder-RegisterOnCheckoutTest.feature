Feature: Registration on checkout


  Scenario Outline: Validate Registration while Checkout after placing an order
    ...
    And And user enters "<username>" and "<emailId>" and clicks on signup button
    ...
    When user click on cart buttom
